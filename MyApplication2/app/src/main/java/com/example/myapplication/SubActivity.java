...
import static com.example.myapplication.R.id.textView_id;
import static com.example.myapplication.R.id.textView_pw;
...
public class SubActivity extends AppCompatActivity {
    ...
    public Action getIndexApiAction() {
        Thing object = new Thing.Builder()
                .setName("Sub Page") // TODO: Define a title for the content shown.
